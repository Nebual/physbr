...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "Phys Break"
 
        #Project url
        self.project_url = "www.nebtown.info"
 
        #Version of program
        self.project_version = "0.0"
 
        #License of the program
        self.license = "Nebcorp Freecense"
 
        #Auhor of program
        self.author_name = "Nebual"
        self.author_email = "nebual@nebtown.info"
        self.copyright = "Copyright wat"
 
        #Description
        self.project_description = "Its a game, bro"
